...
class Pickup_Layer : public engine::layer {
public:
	Pickup_Layer(engine::ref<Player>& player_ref, engine::ref<engine::game_object>& item_ref);
	~Pickup_Layer();
...
private:
	...
	// References to the player and item to pickup.
